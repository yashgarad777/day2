...
class Phone {
	...
	// constructor -> method having the same name as the class name and it does not
	// have any return type
	// if there isn't any constructor then java will automatically create the
	// default constructor
	...
	// overloading constructor || overloading is method with the same name but with
